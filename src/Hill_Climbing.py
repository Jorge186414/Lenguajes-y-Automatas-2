            ...
            if mejora:
                ...
                for j in range(0,len(ruta)):
                     if i != j:
                         ...
                         distancia = evalua_ruta(ruta_tmp)
                         if distancia < dist_actual:
...
def imprimir():
    ...
    coord = {
        ...
        'Guadalajara': (20.677754472859146, -103.3462534877137),
    ...
    ruta = hill_climbing()
    print(ruta)
    return ("Distancia total: " + str(evalua_ruta(ruta)))
